  ...
  operations: [
    {
      template: {
        method: 'GET',
        url: `https://gatewayapi.smallcase.com/v1/plan360degree/engine/transactiondetails?transactionId=${"{transactionId}"}`,
...
export class TransactionDetailsDataSource extends juggler.DataSource
  implements LifeCycleObserver {
  static dataSourceName = 'transactionDetails';
  static readonly defaultConfig = config;

  constructor(
    @inject('datasources.config.transactionDetails', {optional: true})
